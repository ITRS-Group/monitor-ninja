...
class User_Test extends PHPUnit_Framework_TestCase {
	...
	public function disabled_test_ldap_case_sensitivity() /* TODO */
	{
		...
		$this->assertTrue( $user1->username == 'test2', "Returned username isn't the same as database username with, using correct case for login" );
		...
		$this->assertTrue( $user2->username == 'test2', "Returned username isn't the same as database username with, using incorrect case for login" );
