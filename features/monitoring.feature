...
Feature: Monitoring
	...
	Scenario: Host details host commands - Schedule downtime
		...
		And I enter "2023-03-14 14:40" into "cmd_param[start_time]"
		And I click "Submit"
		Then I should see "ERROR: 2023-03-14 14:40 is not a valid date, please adjust it"
		And I shouldn't see "Fatal error"
		And I click "adjust it"
		Then I should see "You are trying to schedule downtime for a host"
		And I enter "2023-03-14 14:40:00" into "cmd_param[start_time]"
		And I enter "2023-03-14 14:50:00" into "cmd_param[end_time]"
		And I click "Submit"
		Then I should see "Your command was successfully submitted"
		When I click "Done"
		And I click "Refresh"
