	...
	public function cmd_info($name = false)
	{
		...
		$command_info = array
			('NONE' => array
			 ...
			 ('nagios_id' => 43,
			  'description' => _('This command is used to allow Nagios to run the host event handler for a service when necessary (if one is defined). '),
			 ...
			 ('nagios_id' => 44,
			  'description' => _('This command is used to temporarily prevent Nagios from running the host event handler for a host. '),
			 ...
			 ('nagios_id' => 45,
			  'description' => _('This command is used to allow Nagios to run the service event handler for a service when necessary (if one is defined). '),
			 ...
			 ('nagios_id' => 46,
			  'description' => _('This command is used to temporarily prevent Nagios from running the service event handler for a service. '),
			 ...
			 ('nagios_id' => 48,
			  'description' => _('This command is used to temporarily prevent Nagios from actively checking the status of a host.  If Nagios needs to check the status of this host, it will assume that it is in the same state that it was in before checks were disabled. '),
			 ...
			 ('nagios_id' => 92,
			  'description' => _('This command is used to allow Nagios to accept passive host check results that it finds in the external command file for a host. '),
			 ...
			 ('nagios_id' => 93,
			  'description' => _('This command is used to stop Nagios from accepting passive host check results that it finds in the external command file for a host.  All passive check results that are found for this host will be ignored. '),
			 ...
			 ('nagios_id' => 96,
			  'description' => _('This command is used to schedule the next check of a host.  Nagios will re-queue the host to be checked at the time you specify. If you select the <i>force check</i> option, Nagios will force a check of the host regardless of both what time the scheduled check occurs and whether or not checks are enabled for the host. '),
			 ...
			 ('nagios_id' => 99,
			  'description' => _('This command is used to have Nagios start obsessing over a service. '),
			 ...
			 ('nagios_id' => 100,
			  'description' => _('This command is used to stop Nagios from obsessing over a service. '),
			 ...
			 ('nagios_id' => 101,
			  'description' => _('This command is used to have Nagios start obsessing over a host. '),
			 ...
			 ('nagios_id' => 102,
			  'description' => _('This command is used to stop Nagios from obsessing over a host. '),
			 ...
			 ('nagios_id' => 121,
			  'description' => _('This command is used to schedule downtime for all hosts in a servicegroup.  During the specified downtime, Nagios will not send notifications out about the hosts. When the scheduled downtime expires, Nagios will send out notifications for the hosts as it normally would.  Scheduled downtimes are preserved across program shutdowns and restarts.  Both the start and end times should be specified in the following format:  <b>mm/dd/yyyy hh:mm:ss</b>. If you select the <i>fixed</i> option, the downtime will be in effect between the start and end times you specify.  If you do not select the <i>fixed</i> option, Nagios will treat this as "flexible" downtime.  Flexible downtime starts when a host goes down or becomes unreachable (sometime between the start and end times you specified) and lasts as long as the duration of time you enter.  The duration fields do not apply for fixed dowtime. '),
