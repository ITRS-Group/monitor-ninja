...
class nagstat_Core {
	...
	const NOTIFICATION_SERVICE_WARNING = 4;
	const NOTIFICATION_SERVICE_UNKNOWN	= 8;
	const NOTIFICATION_SERVICE_CRITICAL	= 16;
	const NOTIFICATION_SERVICE_RECOVERY	= 32;
	const NOTIFICATION_HOST_DOWN = 64;
	const NOTIFICATION_HOST_UNREACHABLE	= 128;
	const NOTIFICATION_HOST_RECOVERY = 256;
	const NOTIFICATION_SERVICE_ACK = 512;
	const NOTIFICATION_HOST_ACK = 1024;
	const NOTIFICATION_SERVICE_FLAP = 2048;
	const NOTIFICATION_HOST_FLAP = 4096;
