 ...
 */
$config['pdf_command'] = '/usr/bin/wkhtmltopdf -q --enable-javascript --no-stop-slow-scripts --print-media-type --disable-internal-links --disable-external-links --margin-top 10 --margin-bottom 10 --header-spacing 25 --footer-spacing 5 --header-html application/media/report_header.html --footer-html application/media/report_footer.html';
