<?php
	...
	*/
	...
	$shortcuts['internal'][] = array('/listview?q=[services] (state != 0 and acknowledged = 0) or (host.state != 0 and host.acknowledged = 0)', 'icon-16 x16-shield-pending', array('title' => 'Unhandled Problems'));
