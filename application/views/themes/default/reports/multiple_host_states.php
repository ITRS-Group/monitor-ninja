...
<?php foreach ($multiple_states as $data) { ?>
		<table summary="<?php echo _('Host state breakdown') ?>" id="multiple_hosts"<?php echo ($create_pdf) ? 'style="border: 1px solid #cdcdcd;" cellpadding="5"' : '';?>>
            <tr>
				...
				<th <?php echo ($create_pdf) ? 'style="width: 90px; font-weight: bold; text-align: right; background-color: #e2e2e2; font-size: 0.9em"' : 'class="headerNone" style="width: 80px"';?>><?php echo _('Up') ?></th>
				<th <?php echo ($create_pdf) ? 'style="width: 95px; font-weight: bold; text-align: right; background-color: #e2e2e2; font-size: 0.9em"' : 'class="headerNone" style="width: 80px"';?>><?php echo _('Unreachable') ?></th>
				<th <?php echo ($create_pdf) ? 'style="width: 90px; font-weight: bold; text-align: right; background-color: #e2e2e2; font-size: 0.9em"' : 'class="headerNone" style="width: 80px"';?>><?php echo _('Down') ?></th>
			...
			<tr class="<?php echo ($i%2 == 0) ? 'even' : 'odd'; $i++?>">
				<td <?php echo ($create_pdf) ? 'style="width: 304px; font-size: 0.9em; background-color: '.$bg_color.'"' : ''; ?>><?php echo _('Average'); ?></td>
			...
			<tr class="group-average <?php echo ($i%2 == 0) ? 'even' : 'odd'?>">
				<td <?php echo ($create_pdf) ? 'style="width: 304px; font-size: 0.9em; background-color: '.$bg_color.'"' : ''; ?>><?php echo ($use_average==0) ? _('Group availability (SLA)') : _('Average'); ?></td>
