		...
		<table id="new_schedule_report_table">
			<tr>
				...
				<td>
					...
					<?php echo help::render('local_persistent_filepath').' '._("Local filepath for disk copy") ?><br /><input type="text" class="schedule" name="local_persistent_filepath" id="local_persistent_filepath" value="" />
				</td>
			</tr>
			<tr>
