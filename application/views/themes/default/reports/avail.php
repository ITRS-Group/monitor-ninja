...
<div id="state_breakdown" style="margin-top: 15px">
	...
	<table summary="<?php echo _('Result table') ?>"<?php echo ($create_pdf) ? ' style="border: 1px solid #cdcdcd" cellpadding="5"' : '';?>>
		...
		<tr>
			...
			<th <?php echo ($create_pdf) ? 'style="width: 354px; font-weight: bold; font-size: 0.9em; background-color: '.$bg_color.'"' : 'class="headerNone left"'; ?>><?php echo _('Type / Reason') ?></th>
			<th <?php echo ($create_pdf) ? 'style="width: 110px; font-weight: bold; font-size: 0.9em; text-align:right; background-color: '.$bg_color.'"' : 'class="headerNone"'; ?>><?php echo _('Time') ?></th>
			<th <?php echo ($create_pdf) ? 'style="width: 110px; font-weight: bold; font-size: 0.9em; text-align:right; background-color: '.$bg_color.'"' : 'class="headerNone"'; ?>><?php echo _('Total time') ?></th>
			<?php if (!$create_pdf) { ?><th class="headerNone left"><?php echo _('Status overview') ?></th><?php } ?>
		</tr>
		...
		<tr class="even" >
			...
			<td <?php echo ($create_pdf) ? 'style="width: 354px; font-size: 0.9em;"' : ''; ?>><?php echo _('Unscheduled') ?></td>
		...
		<tr class="even">
			<td <?php echo ($create_pdf) ? 'style="width: 354px; font-size: 0.9em;"' : 'style="border-left: 0px"'; ?>><?php echo _('Scheduled') ?></td>
		...
		<tr class="dark">
			<td <?php echo ($create_pdf) ? 'style="width: 354px; font-size: 0.9em; background-color: '.$bg_color.'"' : ''; ?>><?php echo _('Total') ?></td>
		...
		<tr class="even">
			...
			<td <?php echo ($create_pdf) ? 'style="width: 354px; font-size: 0.9em;"' : ''; ?>><?php echo _('Not running') ?></td>
		...
		<tr class="even">
			<td <?php echo ($create_pdf) ? 'style="width: 354px; font-size: 0.9em;"' : 'style="border-left: 0px"'; ?>><?php echo _('Insufficient data') ?></td>
		...
		<tr class="even total">
			<th <?php echo ($create_pdf) ? 'style=" font-weight: bold;width: 110px; font-size: 0.9em; background-color: '.$bg_color.'"' : 'class="headerNone left" style="border-top: 0px"'; ?>><?php echo _('All') ?></th>
			<td <?php echo ($create_pdf) ? 'style="width: 354px; font-size: 0.9em; background-color: '.$bg_color.'"' : ''; ?>><?php echo _('Total') ?></td>
