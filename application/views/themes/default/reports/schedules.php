<?php defined('SYSPATH') OR die('No direct access allowed.'); ?>
			<div id="schedules_area">
				...
				<div id="scheduled_summary_reports" style="width: 100%">
					...
					<caption><?php echo $summary_header ?></caption>
						...
						<?php }?>
							<tr id="summary_no_result" class="no-result"<?php if (!empty($summary_schedules) && count($summary_schedules)) { ?> style="display:none"<?php } ?>><td colspan="7"><?php echo $label_no_schedules ?></td></tr>
					</table>
				</div>
			</div>