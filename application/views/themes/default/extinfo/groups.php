...
<table style="border-spacing: 1px; background-color: #dcdccd">
	...
	<tr>
		<td class="status icon">
			<?php echo html::image($this->add_path('icons/16x16/nofity-disabled.png'), array('alt' => $label_disable.' '.$label_notifications_hosts.' '.$label_grouptype, 'title' => $label_disable.' '.$label_notifications_hosts.' '.$label_grouptype)); ?>
		</td>
		<td>
	...
	<tr>
		<td class="status icon">
			<?php echo html::image($this->add_path('icons/16x16/nofity-disabled.png'), array('alt' => $label_disable.' '.$label_notifications_services.' '.$label_grouptype, 'title' => $label_disable.' '.$label_notifications_services.' '.$label_grouptype)); ?>
		</td>
		<td>
