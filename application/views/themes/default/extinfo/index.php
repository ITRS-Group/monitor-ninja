...
<div class="widget left" id="extinfo_current">
	...
	<table class="extinfo">
		<tr>
			<td style="width: 160px"><?php echo $lable_current_status ?></td>
			<td>
				<?php echo html::image('/application/views/themes/default/images/icons/12x12/shield-'.strtolower($current_status_str).'.png', array('alt' => $current_status_str, 'style' => 'margin-bottom: -2px'));?>
		...
		<tr>
			...
			<td>
				<?php echo html::image('/application/views/themes/default/images/icons/12x12/shield-'.strtolower($check_type).'.png',array('alt' => $check_type, 'style' => 'margin-bottom: -2px; margin-right: 2px'));?>
		...
		<tr>
			...
			<td>
				<?php echo html::image('/application/views/themes/default/images/icons/12x12/flapping-'.strtolower($flap_value).'.png',$flap_value);?>
		...
		<tr>
			...
			<td>
				<?php echo html::image('/application/views/themes/default/images/icons/12x12/sched-downtime-'.strtolower($scheduled_downtime_depth).'.png',$scheduled_downtime_depth);?>
		...
		<tr>
			...
			<td>
				<?php echo html::image('/application/views/themes/default/images/icons/12x12/shield-'.strtolower($active_checks_enabled).'.png',$active_checks_enabled);?>
