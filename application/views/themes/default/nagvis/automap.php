...
<div style="margin-left: 1px;">
	<iframe name="nagvis" id="nagvis" src="/nagvis/frontend/nagvis-js/index.php?mod=AutoMap&act=view&show=__automap<?php echo $querystring; ?>" width="100%" onload="highlight();">
