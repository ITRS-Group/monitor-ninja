		...
		<caption><?php echo _('Availability Reports') ?></caption>
			...
			<tbody>
				<?php	$recipients = false; $i = 0;
					...
					<td>
						<form><input type="button" class="send_report_now" data-schedule="<?php echo $schedule->id ?>" data-report_id="<?php echo $schedule->report_id ?>" data-type="avail" title="<?php echo _('Send this report now') ?>" value="&nbsp;"></form>
		...
		<caption><?php echo _('SLA Reports') ?></caption>
			...
			<tbody>
				<?php	$recipients = false;
					...
					<td class="iseditable" title="<?php echo _('Double click to edit') ?>" id="local_persistent_filepath-<?php echo $schedule->id ?>"><?php echo $schedule->local_persistent_filepath ?></td>
					<td>
						<form><input type="button" class="send_report_now" data-schedule="<?php echo $schedule->id ?>" data-report_id="<?php echo $schedule->report_id ?>" data-type="sla" title="<?php echo _('Send this report now') ?>" value="&nbsp;"></form>
		...
		<caption><?php echo _('Alert Summary Reports') ?></caption>
			...
			<tbody>
				<?php	$recipients = false;
					...
					<td class="iseditable" title="<?php echo _('Double click to edit') ?>" id="local_persistent_filepath-<?php echo $schedule->id ?>"><?php echo $schedule->local_persistent_filepath ?></td>
					<td>
						<form><input type="button" class="send_report_now" data-schedule="<?php echo $schedule->id ?>" data-report_id="<?php echo $schedule->report_id ?>" data-type="summary" title="<?php echo _('Send this report now') ?>" value="&nbsp;"></form>
