<head>
	...
	<script type="text/javascript" src="<?php echo url::base().'application/views/themes/default/dojo/mlib.aux.js'; ?>"></script>
	
	<script type="text/javascript" src="<?php echo url::base().'application/views/themes/default/dojo/mlib.bind.js'; ?>"></script>
	<script type="text/javascript" src="<?php echo url::base().'application/views/themes/default/dojo/mlib.get.js'; ?>"></script>
	<script type="text/javascript" src="<?php echo url::base().'application/views/themes/default/dojo/mlib.store.js'; ?>"></script>
