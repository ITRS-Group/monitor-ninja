		...
		<tbody>
			...
			<tr class="<?php echo ($i%2 == 0) ? 'odd' : 'even'?>">
				...
				<td class="icon">
					...
					echo html::anchor('extinfo/details/?'.$grouptype.'group='.urlencode($details['name']),html::image($this->add_path('icons/16x16/extended-information.gif'), array('alt' => _('View commands for this group'), 'title' => _('View commands for this group'))), array('class' => 'image-link'));
					?>
				</td>
				<?php if( $grouptype == 'host' ) { ?>
