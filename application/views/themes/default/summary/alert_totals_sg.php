...
<div class="left w98">
	...
	foreach ($result as $sg_name => $ary) {
		$this->_print_alert_totals_table(_('Host Alerts'), $ary['host'], $host_state_names, $ary['host_totals'], $sg_name);
		$this->_print_alert_totals_table(_('Service Alerts'), $ary['service'], $service_state_names, $ary['service_totals'], $sg_name);
	}
