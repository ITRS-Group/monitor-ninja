	...
	<table id="network_outages_table">
		...
		<tbody>
			...
			<tr class="<?php echo ($i%2 == 0) ? 'odd' : 'even' ?>">
				...
				<td class="icon">
					<?php echo html::anchor('status/host/'.$host, html::image($this->add_path('icons/16x16/service-details.gif'),array('alt' => $this->translate->_('View status detail for this host'), 'title' => $this->translate->_('View status detail for this host'))),array('style' => 'border: 0px')) ?>
				</td>
				<td class="icon">
				...
				<td class="icon">
					<?php echo html::anchor('history/host/'.$host, html::image($this->add_path('icons/16x16/history.gif'),array('alt' => $this->translate->_('View alert history for this host'), 'title' => $this->translate->_('View alert history for this host'))),array('style' => 'border: 0px')) ?>
				</td>
				<td class="icon">
