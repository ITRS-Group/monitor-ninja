...
/* Hack for lack of console.log() in ie7 */
	...
	<script type="text/javascript">
		...
		<?php
			...
			var _notes_url_target = "<?php echo htmlspecialchars(config::get('nagdefault.notes_url_target') . ""); ?>";
			var _action_url_target = "<?php echo htmlspecialchars(config::get('nagdefault.action_url_target') . ""); ?>";
		...
		<?php if ($keycommands_active === 1) { ?>
				...
				var _keycommands_active='<?php echo htmlspecialchars(config::get('keycommands.activated') . ""); ?>';
				var _keycommand_search='<?php echo htmlspecialchars(config::get('keycommands.search') . ""); ?>';
				var _keycommand_pause='<?php echo htmlspecialchars(config::get('keycommands.pause') . ""); ?>';
				var _keycommand_forward='<?php echo htmlspecialchars(config::get('keycommands.forward') . ""); ?>';
				var _keycommand_back='<?php echo htmlspecialchars(config::get('keycommands.back') . ""); ?>';
		<?php 	} else { ?>
