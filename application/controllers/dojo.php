 ...
 *  PARTICULAR PURPOSE.
 */
class Dojo_Controller extends Authenticated_Controller {
	public function index()
	{
		$this->template->content = $this->add_view('/dojo/index');
		$this->template->title = _('Monitoring » Tactical overview (Dojo)');
