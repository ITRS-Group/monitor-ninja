	...
	*/
	public static function _helptexts($id)
	{
		...
		$helptexts = array(
			...
			'config.use_popups' => $t->_('Enable or disable the use of pop-ups for performance graphs and comments.'),
			'config.popup_delay' => $t->_('Set the delay in milliseconds before the pop-ups (performance graphs and comments) will be shown. Defaults to 1500ms (1.5s).'),
