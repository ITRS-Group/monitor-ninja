...
class OutputDriverGeneric extends OutputDriver {
  ...
  function mk_filename() {
    ...
    // Linux
    $filename = tempnam($HTML2PS_WRITER_TEMPDIR,WRITER_FILE_PREFIX);
    ...
    if ($filehandle === false) {
      ...
      $tries = 0;
      do {
        $filename = $HTML2PS_WRITER_TEMPDIR.DIRECTORY_SEPARATOR.WRITER_FILE_PREFIX.md5(uniqid(rand(), true));
