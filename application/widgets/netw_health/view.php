		...
		<table summary="Network healt" class="healt">
				<tr>
					<td style="text-align: center">
						...
						<div class="border">
							<?php echo html::image($host_image, array('style' => 'height:'.$host_value.'px; width: 100%', 'alt' => $host_label)) ?>
						</div>
					</td>
					<td style="text-align: center">
						...
						<div class="border">
							<?php echo html::image($service_image, array('style' => 'height:'.$service_value.'px; width: 100%', 'alt' => $service_label)) ?>
						</div>
					</td>
				</tr>
			</table>
