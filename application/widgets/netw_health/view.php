		...
		<table summary="Network healt" class="healt">
				<tr>
					<td style="text-align: center">
						<div style=" font-size: 22px; position: absolute; padding-top: 62px; padding-left: 10px;"><?php echo $host_value ?> %</div>
						<div style=" font-size: 10px; position: absolute; padding-top: 84px; padding-left: 10px"><?php echo $host_label ?></div>
						<div class="border">
					...
					<td style="text-align: center">
						<div style=" font-size: 22px; position: absolute;padding-top: 62px; padding-left: 10px"><?php echo $service_value ?> %</div>
						<div style=" font-size: 10px; position: absolute; padding-top: 84px; padding-left: 10px;"><?php echo $service_label ?></div>
						<div class="border">
