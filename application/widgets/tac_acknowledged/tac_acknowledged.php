...
class Tac_acknowledged_Widget extends widget_Core {
	...
	public function index($arguments=false, $master=false)
	{
		...
		if ($current_status->hosts_down_acknowledged) {
			...
			$problem[$i]['title'] = $current_status->hosts_down_acknowledged.' '.$this->translate->_('acknowledged').' '.$this->translate->_('Hosts');
			$i++;
		}
		...
		if ($current_status->hosts_unreachable_acknowledged) {
			...
			$problem[$i]['title'] = $current_status->hosts_unreachable_acknowledged.' '.$this->translate->_('acknowledged').' '.$this->translate->_('Hosts');
			$i++;
		}
		...
		if ($current_status->services_critical_acknowledged) {
			...
			$problem[$i]['title'] = $current_status->services_critical_acknowledged.' '.$this->translate->_('acknowledged').' '.$this->translate->_('Services');
			$i++;
		}
		...
		if ($current_status->services_warning_acknowledged) {
			...
			$problem[$i]['title'] = $current_status->services_warning_acknowledged.' '.$this->translate->_('acknowledged').' '.$this->translate->_('Services');
			$i++;
		}
		...
		if ($current_status->services_unknown_acknowledged) {
			...
			$problem[$i]['title'] = $current_status->services_unknown_acknowledged.' '.$this->translate->_('acknowledged').' '.$this->translate->_('Services');
			$i++;
		}
