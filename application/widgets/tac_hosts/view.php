				...
				<td class="white">
					<table>
							...
							<tr>
								...
								<?php
									$icon = explode(' ',$title);
									echo html::image($this->add_path('icons/16x16/'.(($icon[1] == 'Unhandled') ? 'shield-critical' : strtolower($icon[1])).'.png'),$icon[1]);
								?>
								</td>
					...
					<table>
							...
							<tr>
								<td class="dark">
									<?php
										$icon = explode(' ',$title);
										echo html::image($this->add_path('icons/16x16/'.(($icon[1] == 'Unhandled') ? 'shield-unreachable' : strtolower($icon[1])).'.png'),$icon[1]);
									?>
								</td>
								<td><?php echo html::anchor($url, html::specialchars($title)) ?></td>
							</tr>
