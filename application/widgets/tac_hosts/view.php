			...
			<tr>
				<td style="padding: 0px" class="white">
					<table>
							...
							<tr>
								<td class="dark"><?php echo html::image('/application/views/themes/default/images/icons/16x16/shield-critical.png',$title) ?></td>
				...
				<td style="padding: 0px" class="white">
					<table>
							...
							<tr>
								<td class="dark"><?php echo html::image('/application/views/themes/default/images/icons/16x16/shield-unreachable.png',$this->translate->_('Unreachable')) ?></td>
								<td><?php echo html::anchor($url, html::specialchars($title)) ?></td>
							</tr>
							<?php } } else { ?>
							<tr>
