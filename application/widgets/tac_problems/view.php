		...
		<table class="w-table">
			<?php for ($i = 0; $i < count($problem); $i++) { ?>
				<tr>
					...
					<td style="white-space: normal;background:<?php echo $problem[$i]['bgcolor']?>" <?php if ($problem[$i]['bgcolor']=='') {?> class="status-<?php echo strtolower($problem[$i]['status']); ?>"<?php } ?> id="<?php echo $problem[$i]['html_id']?>">
