...
<div class="widget movable collapsable removable closeconfirm w32 left" id="widget-tac_scheduled">
	<div class="widget-header"><span><?php echo $this->translate->_('Scheduled downtime') ?></span></div>
