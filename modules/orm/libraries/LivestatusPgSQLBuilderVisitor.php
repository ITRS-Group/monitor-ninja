...
/**
 * Used within the parser as a parse visitor of a lsfilter to generate a ORM
 * object set
 */
class LivestatusPgSQLBuilderVisitor implements LivestatusFilterVisitor {
	/**
	 * a callback for converting a ORM layer column name to a database layer
	 * column name
	 */
	 ...
	 *
	 * @param $column_formatter a
	 *        	callback for converting a ORM layer column name to a database
	 *        	layer column name
	 */
