...
CREATE TABLE avail_config (
  ...
  rpttimeperiod VARCHAR2(75 CHAR) NOT NULL,
  report_period VARCHAR2(50 CHAR) NOT NULL,
  ...
  scheduleddowntimeasuptime NUMBER(10,0) DEFAULT '0' NOT NULL,
  assumestatesduringnotrunning NUMBER(10,0) DEFAULT '0' NOT NULL,
  includesoftstates NUMBER(10,0) DEFAULT '0' NOT NULL,
  ...
  cluster_mode NUMBER(10,0) DEFAULT '0' NOT NULL,
